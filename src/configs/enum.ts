...
export const ContractStatusList: Record<ContractStatus, EnumInfo> = {
...
// 假设 EnumInfo 类型已定义，如：type EnumInfo = { value: number; label: string }
// 如果未定义，可补充：
// type EnumInfo = { value: number; label: string };
